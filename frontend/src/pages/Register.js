  ...
  return (
    <div className="grid min-h-screen lg:grid-cols-2 bg-[#07090e] text-slate-100 relative overflow-hidden aurora-bg">
      ...
      <div className="flex items-center justify-center p-6 sm:p-12 z-10">
        <Card className="rich-card w-full max-w-lg p-8 bg-[#0d1322]/90 border-white/[0.1] shadow-2xl">
          <div className="mb-6">
            ...
            <p className="mt-1 text-xs text-slate-400">Deploy intelligence across your entire commercial fleet.</p>
          </div>

          <form onSubmit={submit} className="space-y-4">
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              <div className="space-y-1.5">
                <Label htmlFor="full_name" className="text-xs font-bold text-slate-300">Full Name</Label>
              ...
              <div className="space-y-1.5">
                <Label htmlFor="company_name" className="text-xs font-bold text-slate-300">Fleet / Company</Label>
                <div className="relative">
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <div className="space-y-1.5">
                <Label htmlFor="phone" className="text-xs font-bold text-slate-300">Phone (optional)</Label>
                <div className="relative">
