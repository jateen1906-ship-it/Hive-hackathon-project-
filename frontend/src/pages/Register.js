  ...
  return (
    <div className="grid min-h-screen lg:grid-cols-2 bg-[#f1f5f9] text-slate-900">
      ...
      <div className="flex items-center justify-center p-6 sm:p-12">
        <Card className="w-full max-w-lg p-8 bg-white border border-slate-200 shadow-sm">
          <div className="mb-6">
          ...
          <form onSubmit={submit} className="space-y-4">
            ...
            <Button 
              type="submit" 
              className="btn-primary-blue w-full font-semibold rounded-lg h-10 text-xs shadow-2xs mt-2" 
              disabled={loading} 
