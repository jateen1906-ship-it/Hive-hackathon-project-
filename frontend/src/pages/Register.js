  ...
  return (
    <div className="grid min-h-screen lg:grid-cols-2 bg-[#12100e] text-[#f5f5f4]">
      ...
      <div className="flex items-center justify-center p-6 sm:p-12">
        <Card className="alvero-card w-full max-w-lg p-8 bg-[#181512] border-white/[0.08]">
          <div className="mb-6">
            ...
            <p className="mt-1 text-sm text-[#9e958d]">Set up your fleet workspace in seconds.</p>
          </div>

          <form onSubmit={submit} className="space-y-4">
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              <div className="space-y-1.5">
                <Label htmlFor="full_name" className="text-xs font-semibold text-[#d6d3d1]">Full Name</Label>
              ...
              <div className="space-y-1.5">
                <Label htmlFor="company_name" className="text-xs font-semibold text-[#d6d3d1]">Company</Label>
                <div className="relative">
                  <Building2 className="absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 text-[#78716c]" />
                  <Input 
                    id="company_name" 
            ...
            <div className="space-y-1.5">
              <Label htmlFor="email" className="text-xs font-semibold text-[#d6d3d1]">Work Email</Label>
              <div className="relative">
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <div className="space-y-1.5">
                <Label htmlFor="phone" className="text-xs font-semibold text-[#d6d3d1]">Phone (optional)</Label>
                <div className="relative">
            ...
            <Button 
              type="submit" 
              className="btn-sunset-orange w-full font-semibold rounded-xl h-11 text-sm shadow-md mt-2" 
              disabled={loading} 
