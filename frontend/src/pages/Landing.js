    ...
    <div className="min-h-screen bg-[#f1f5f9] text-slate-900">
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between">
          <div className="flex items-center gap-3 cursor-pointer" onClick={() => navigate("/")}>
            ...
            <div>
              ...
              <div className="text-[10px] uppercase tracking-wider text-slate-500 font-semibold">Compliance Intel</div>
            </div>
          </div>
      ...
      <section className="bg-white border-b border-slate-200 py-16 sm:py-24">
        <div className="mx-auto max-w-5xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <p className="mt-6 max-w-2xl mx-auto text-base text-slate-600 sm:text-lg leading-relaxed">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-14 grid grid-cols-1 gap-6 md:grid-cols-3">
            <div className="bg-white rounded-xl p-8 border border-slate-200 shadow-2xs">
              <div className="text-4xl font-extrabold font-mono text-blue-600/30">01</div>
            ...
            <div className="bg-white rounded-xl p-8 border border-slate-200 shadow-2xs">
              <div className="text-4xl font-extrabold font-mono text-blue-600/30">02</div>
            ...
            <div className="bg-white rounded-xl p-8 border border-slate-200 shadow-2xs">
              <div className="text-4xl font-extrabold font-mono text-blue-600/30">03</div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            <div className="bg-[#f8fafc] rounded-xl p-7 border border-slate-200">
              <Route className="h-6 w-6 text-blue-600 mb-3" />
