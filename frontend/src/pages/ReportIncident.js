      ...
      <div className="mx-auto max-w-md text-center pt-8">
        <Card className="p-8">
          ...
          <div className="mt-6 flex justify-center gap-3">
            <Button onClick={() => navigate("/incidents")} data-testid="incident-view-all" className="btn-primary-blue text-xs font-semibold h-9 px-4">View Incidents</Button>
            <Button variant="outline" onClick={() => { setCreated(null); setDocs([]); setForm((f) => ({ ...f, location_name: "", reason: "", notes: "" })); }} className="border-slate-200 text-xs font-semibold text-slate-700 h-9">Report Another</Button>
          </div>
        </Card>
      </div>
    );
      ...
      <form onSubmit={submit} className="space-y-4">
        <Card className="space-y-4 p-6">
          <div className="space-y-1.5">
            <Label htmlFor="loc" className="text-xs text-slate-700 font-medium">Location / Toll Plaza / Border</Label>
          ...
          <div className="space-y-1.5">
            <Label className="text-xs text-slate-700 font-medium">Incident Type</Label>
          ...
          <div className="space-y-1.5">
            <Label htmlFor="reason" className="text-xs text-slate-700 font-medium">Reason Provided by Authority</Label>
          ...
          <div className="space-y-2">
            <Label className="text-xs text-slate-700 font-medium">Documents Demanded</Label>
          ...
          <div className="space-y-1.5">
            <Label className="text-xs text-slate-700 font-medium">Inspection Outcome</Label>
          ...
          <div className="space-y-1.5">
            <Label className="text-xs text-slate-700 font-medium">Link to Active Trip (Optional)</Label>
          ...
          <div className="space-y-1.5">
            <Label htmlFor="notes" className="text-xs text-slate-700 font-medium">Additional Field Notes</Label>
        ...
        <Button type="submit" size="lg" className="btn-primary-blue w-full font-semibold rounded-lg h-11 text-sm shadow-xs" disabled={busy} data-testid="incident-submit-button">
